...
export type GetCourseClassAggregateType<T extends CourseClassAggregateArgs> = {
    [P in keyof T & keyof AggregateCourseClass]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateCourseClass[P]> : Prisma.GetScalarType<T[P], AggregateCourseClass[P]>;
};
...
type GetCourseClassGroupByPayload<T extends CourseClassGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<CourseClassGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof CourseClassGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], CourseClassGroupByOutputType[P]> : Prisma.GetScalarType<T[P], CourseClassGroupByOutputType[P]>;
}>>;
export type CourseClassWhereInput = {
    ...
    enrolledCount?: Prisma.IntFilter<"CourseClass"> | number;
    status?: Prisma.EnumCourseClassStatusFilter<"CourseClass"> | $Enums.CourseClassStatus;
...
export type CourseClassScalarWhereWithAggregatesInput = {
    ...
    enrolledCount?: Prisma.IntWithAggregatesFilter<"CourseClass"> | number;
    status?: Prisma.EnumCourseClassStatusWithAggregatesFilter<"CourseClass"> | $Enums.CourseClassStatus;
...
export type CourseClassUpdateInput = {
    ...
    status?: Prisma.EnumCourseClassStatusFieldUpdateOperationsInput | $Enums.CourseClassStatus;
...
export type CourseClassOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "courseId" | "name" | "startDate" | "endDate" | "schedule" | "location" | "vacancies" | "enrolledCount" | "status" | "createdAt" | "updatedAt", ExtArgs["result"]["courseClass"]>;
...
export type CourseClassCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<CourseClassFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CourseClassDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['CourseClass'];
        meta: {
            name: 'CourseClass';
        };
    };
     ...
     * })
    **/
    count<T extends CourseClassCountArgs>(args?: Prisma.Subset<T, CourseClassCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], CourseClassCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends CourseClassGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, CourseClassGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCourseClassGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface CourseClassFieldRefs {
    ...
    readonly schedule: Prisma.FieldRef<"CourseClass", 'String'>;
    readonly location: Prisma.FieldRef<"CourseClass", 'String'>;
    readonly vacancies: Prisma.FieldRef<"CourseClass", 'Int'>;
    readonly enrolledCount: Prisma.FieldRef<"CourseClass", 'Int'>;
    readonly status: Prisma.FieldRef<"CourseClass", 'CourseClassStatus'>;
